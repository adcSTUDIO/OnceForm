...
// build the form programatically by creating HTML in a string
// using whatever method or library you like.
$html = '<form action="'.$_SERVER['PHP_SELF'].'" method="post">';
$html .= '<p><input type="email" name="user_email" placeholder="Enter your email address"></p>';
...
// slightly more boilerplate than the fully automatic way
